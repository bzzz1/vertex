...
@section('body')
	<div class="width_960">
		<div class = "catalog_gen">
			<h2 class = "groups_title">{{ $current_param }}</h2>
			<div class="catalog_sort">
				...
				<div class="catalog_sort_pages_div">
					<ul class="catalog_sort_pages_ul">
						...
						<li class="catalog_sort_pages catalog_sort_pages_li dots"><a href="#">... </a></li>
				...
				@foreach($items as $item)
					<div class="catalog_item">
						...
						<table class = "info_item_page">
							<tr>
								<td class='info_page_item_p'>Производитель:&nbsp</td>
								<td class='info_page_item_p'>{{ $item->producer }}</td>
							</tr>
							<tr>
								<td class='info_page_item_p'>Код:&nbsp</td>
								<td class='info_page_item_p'>{{ $item->code }}</td>
							</tr>
							<tr>
								<td class='info_page_item_p center' colspan='2'>Под заказ</td>
							</tr>
						</table>

						<div class="catalog_item_price">
							<p class="catalog_item_price_p catalog_item_price_number">{{ $item->retail_price }}&nbsp</p>
							...
							<div class="item_main clearfix">
								...
								<div class="item_page_right_div">
									...
									<div class="item_price">
										<p class="item_price_p item_price_number">{{ $item->retail_price }}&nbsp</p>
