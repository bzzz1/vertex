...
//
//
//	private function _timer_start() { // add error timing
//		global $__start;
//		date_default_timezone_set('Europe/Moscow');
//		// echo 'Start at: '.date('H:i:s');
//		$__start = microtime(true);
//	}
//	private function _memuse($line = 'unknown') {
//		echo "</br>memory_get_usage(true) on line $line</br>";
//		echo round(memory_get_usage(true)/1024/1024, 2);
//		echo ' Mb</br>';
//	}
//	private function _mempeak($line = 'unknown') {
//		$round = round(memory_get_peak_usage(true)/1024/1024, 2);
//		return "</br>Максимальная загрузка памяти: ".$round.' Mb</br>';
//	}
...
//		return public_path().DIRECTORY_SEPARATOR.'excel'.DIRECTORY_SEPARATOR.'excel.xlsx';
//	}
//}
